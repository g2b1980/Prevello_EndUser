import {
  ...
  UrlString,
  WrapperSKU
} from "./chunk-QCXPI6GO.js";
import "./chunk-IOOOT62O.js";
import {
  Router
    ...
    for (const property of urlProperties) {
      if (keyComponents[property]) {
        ...
        if (this.msalInterceptorConfig.strictMatching) {
          const component = property === "pathname" ? "path" : property;
          if (!StringUtils.matchPatternStrict(decodedInput, endpointComponents[property], {
            component
          })) {
            return false;
          }
