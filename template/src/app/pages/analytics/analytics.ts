...
export class AnalyticsPage {
	...
	nextDate = moment().add(+1, 'd').format('D MMM YYYY');
  ...
  renderChart1() {
  	this.chart1Data = {
			...
			datasets: [{
				pointBorderColor: this.appVariables.color.primary,
				backgroundColor: 'transparent',
				borderColor: this.appVariables.color.primary,
				borderWidth: 2,
				pointBackgroundColor: this.appVariables.color.bodyBg,
				pointBorderWidth: 2,
				pointRadius: 4,
				pointHoverBackgroundColor: this.appVariables.color.bodyBg,
				pointHoverBorderColor: this.appVariables.color.primary,
				pointHoverRadius: 6,
  ...
  renderChart3() {
		this.chart3Data = {
			...
			datasets: [{
				...
				pointBorderColor: this.appVariables.color.teal,
				backgroundColor: this.appVariables.color.teal,
				...
				pointRadius: 4,
				pointHoverBackgroundColor: this.appVariables.color.bodyBg,
				pointHoverBorderColor: this.appVariables.color.teal,
				pointHoverRadius: 6,
				pointHoverBorderWidth: 2,
				data: [0, 0, 10, 26, 13]
			}]
