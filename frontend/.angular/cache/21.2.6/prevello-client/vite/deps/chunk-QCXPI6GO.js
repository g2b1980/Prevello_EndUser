...
${serverError}`);
   ...
   * @param authority
   */
  handleServerTokenResponse(serverTokenResponse, authority, reqTimestamp, request, apiId, authCodePayload, userAssertionHash, handlingRefreshTokenResponse, forceCacheRefreshTokenResponse, serverRequestId) {
    return __async(this, null, function* () {
...
var RefreshTokenClient = class extends BaseClient {
  ...
  acquireTokenByRefreshToken(request, apiId) {
    return __async(this, null, function* () {
      ...
      if (isFOCI) {
        try {
          return yield invokeAsync(this.acquireTokenWithCachedRefreshToken.bind(this), PerformanceEvents.RefreshTokenClientAcquireTokenWithCachedRefreshToken, this.logger, this.performanceClient, request.correlationId)(request, true, apiId);
        } catch (e) {
  ...
  acquireTokenWithCachedRefreshToken(request, foci, apiId) {
    return __async(this, null, function* () {
      ...
      try {
        return yield invokeAsync(this.acquireToken.bind(this), PerformanceEvents.RefreshTokenClientAcquireToken, this.logger, this.performanceClient, request.correlationId)(refreshTokenRequest, apiId);
      } catch (e) {
...
var InteractionHandler = class {
  ...
  handleCodeResponseFromServer(authCodeResponse, request, apiId, validateNonce = true) {
    return __async(this, null, function* () {
      ...
      const tokenResponse = yield invokeAsync(this.authModule.acquireToken.bind(this.authModule), PerformanceEvents.AuthClientAcquireToken, this.logger, this.performanceClient, request.correlationId)(this.authCodeRequest, apiId, authCodeResponse);
...
function handleResponseCode(request, response, codeVerifier, apiId, config, authClient, browserStorage, nativeStorage, eventHandler, logger, performanceClient, platformAuthProvider) {
  return __async(this, null, function* () {
    ...
    const result = yield invokeAsync(interactionHandler.handleCodeResponse.bind(interactionHandler), PerformanceEvents.HandleCodeResponse, logger, performanceClient, request.correlationId)(response, request, apiId);
    return result;
  });
}
function handleResponseEAR(request, response, apiId, config, authority, browserStorage, nativeStorage, eventHandler, logger, performanceClient, platformAuthProvider) {
  return __async(this, null, function* () {
    ...
    return yield invokeAsync(responseHandler.handleServerTokenResponse.bind(responseHandler), PerformanceEvents.HandleServerTokenResponse, logger, performanceClient, request.correlationId)(decryptedData, authority, TimeUtils_exports.nowSeconds(), request, apiId, additionalData, void 0, void 0, void 0, void 0);
  });
}
...
function isPlatformBrokerAvailable(loggerOptions, perfClient, correlationId, domConfig) {
  return __async(this, null, function* () {
...
var SilentIframeClient = class extends StandardInteractionClient {
  ...
  verifySso(request) {
    return __async(this, null, function* () {
      ...
      const silentRequest = yield invokeAsync(this.initializeAuthorizationRequest.bind(this), PerformanceEvents.StandardInteractionClientInitializeAuthorizationRequest, this.logger, this.performanceClient, request.correlationId)(inputRequest, InteractionType.Silent);
      const authClient = yield invokeAsync(this.createAuthCodeClient.bind(this), PerformanceEvents.StandardInteractionClientCreateAuthCodeClient, this.logger, this.performanceClient, request.correlationId)({
        serverTelemetryManager: this.initializeServerTelemetryManager(this.apiId),
        requestAuthority: silentRequest.authority,
        requestAzureCloudOptions: silentRequest.azureCloudOptions,
      ...
      const pkceCodes = yield invokeAsync(generatePkceCodes, PerformanceEvents.GeneratePkceCodes, this.logger, this.performanceClient, correlationId)(this.performanceClient, this.logger, correlationId);
      const requestWithPkce = __spreadProps(__spreadValues({}, silentRequest), {
        codeChallenge: pkceCodes.challenge
      });
      const navigateUrl = yield invokeAsync(getAuthCodeRequestUrl, PerformanceEvents.GetAuthCodeUrl, this.logger, this.performanceClient, correlationId)(this.config, authClient.authority, requestWithPkce, this.logger, this.performanceClient);
...
var TokenCache = class {
  ...
  loadExternalTokens(request, response, options) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const authority = yield AuthorityFactory_exports.createDiscoveredInstance(Authority.generateAuthority(authorityString, request.azureCloudOptions), this.config.system.networkClient, this.storage, authorityOptions, this.logger, correlationId, this.performanceClient);
        const cacheRecordAccount = yield invokeAsync(this.loadAccount.bind(this), PerformanceEvents.LoadAccount, this.logger, this.performanceClient, correlationId)(request, options.clientInfo || response.client_info || "", correlationId, authority, idTokenClaims);
        const idToken = yield invokeAsync(this.loadIdToken.bind(this), PerformanceEvents.LoadIdToken, this.logger, this.performanceClient, correlationId)(response, cacheRecordAccount.homeAccountId, cacheRecordAccount.environment, cacheRecordAccount.realm, correlationId, kmsi);
        const accessToken = yield invokeAsync(this.loadAccessToken.bind(this), PerformanceEvents.LoadAccessToken, this.logger, this.performanceClient, correlationId)(request, response, cacheRecordAccount.homeAccountId, cacheRecordAccount.environment, cacheRecordAccount.realm, options, correlationId, kmsi);
        const refreshToken = yield invokeAsync(this.loadRefreshToken.bind(this), PerformanceEvents.LoadRefreshToken, this.logger, this.performanceClient, correlationId)(response, cacheRecordAccount.homeAccountId, cacheRecordAccount.environment, correlationId, kmsi);
   ...
   */
  loadAccount(request, clientInfo, correlationId, authority, idTokenClaims) {
    return __async(this, null, function* () {
      this.logger.verbose("TokenCache - loading account");
      if (request.account) {
        const accountEntity = AccountEntity.createFromAccountInfo(request.account);
        yield this.storage.setAccount(accountEntity, correlationId, AuthToken_exports.isKmsi(idTokenClaims || {}), ApiId.loadExternalTokens);
      ...
      yield this.storage.setAccount(cachedAccount, correlationId, AuthToken_exports.isKmsi(idTokenClaims || {}), ApiId.loadExternalTokens);
  ...
  initialize(request, isBroker) {
    return __async(this, null, function* () {
      ...
      if (allowPlatformBroker) {
        try {
          this.platformAuthProvider = yield getPlatformAuthProvider(this.logger, this.performanceClient, initCorrelationId, this.config.system.nativeBrokerHandshakeTimeout, this.config.system.allowPlatformBrokerWithDOM);
        } catch (e) {
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-M5VV3MWQ.js");
    }
  } catch (e) {
  }
  return void 0;
...
//# sourceMappingURL=chunk-QCXPI6GO.js.map
