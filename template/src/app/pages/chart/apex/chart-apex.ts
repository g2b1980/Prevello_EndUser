  ...
  getChart1Options() {
	...
	getChart2Options() {
		return {
			...
			colors: [this.appVariables.color.theme, this.appVariables.color.indigo, this.appVariables.color.dark],
			xaxis: {
	...
	getChart3Options() {
		return {
			...
			xaxis: {
				type: 'datetime',
				categories: ['2026-09-19T00:00:00', '2026-09-19T01:30:00', '2026-09-19T02:30:00', '2026-09-19T03:30:00', '2026-09-19T04:30:00', '2026-09-19T05:30:00', '2026-09-19T06:30:00'],
				axisBorder: {
					show: true,
					color: this.appVariables.color.borderColor,
					height: 1,
	...
	getChart5Options() {
		return {
			...
			title: {
				text: 'XYZ - Stock Analysis (2015 - 2026)',
				align: 'left',
				offsetX: 110,
				style: {
					fontSize: '14px',
	...
	getChart7Options() {
		return {
			series: [
				{ name: 'Bubble1', data: this.generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) },
				{ name: 'Bubble2', data: this.generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) },
				{ name: 'Bubble3', data: this.generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) },
				{ name: 'Bubble4', data: this.generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) }
			],
			chart: {
				height: 350,
				type: 'bubble',
